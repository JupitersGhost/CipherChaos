#!/usr/bin/env python3
"""
CipherChaos Chaos GUI v2.1 - Enhanced Version with PQC Support
Enhanced entropy generation with ESP32-S3 v2.1 firmware integration
Post-Quantum Cryptography integration with enhanced entropy auditing
"""
...
def _cc_get_icon():
    ...
    if p and os.path.exists(p):
        return QIcon(p)
    # Fallback: colored pixmap
    pm = QPixmap(32, 32)
    pm.fill(QColor(64, 160, 255))
    return QIcon(pm)

def _cc_get_pixmap(size=60):
    p = _cc_icon_path()
    if p and os.path.exists(p):
        pm = QPixmap(p)
...
# Color scheme matching CipherChaos's aesthetic
CIPHER_COLORS = {
    'bg': '#0b0f14',
    'panel': '#121824', 
    'accent': '#c400ff',
...
DEFAULT_DIR = Path.home() / "Desktop" / "CipherChaos"
...
class CipherChanWorker(QObject):
    ...
    def __init__(self):
        ...
        self.cipher_quips = [
            ...
            "USB jitter swallowed whole—entropy's dessert course! (•̀ᴗ•́ )و",
    ...
    def start_system(self):
        ...
        if self.pqc_enabled and PQC_AVAILABLE:
            self.quip_generated.emit("Kyber crystals aligned—let the lattice sing.")
        else:
...
class CipherChanMainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("cipherchaos")
        ...
        self.status_bar.showMessage("CipherChaos Chaos System Ready")
    ...
    def create_header(self):
        ...
        title = QLabel("CipherChaos Chaos System v2.1")
        title.setStyleSheet("font-size: 24px; font-weight: bold; color: white;")
        
        subtitle = QLabel("ESP32-S3 Enhanced Entropy Generation & CobraMesh Interface")
    ...
    def create_audit_panel(self):
        ...
        self.audit_score_label.setStyleSheet(f"font-size: 18px; font-weight: bold; color: {CIPHER_COLORS['success']};")
    ...
    def create_quip_panel(self):
            ...
            self.quip_display.setPlaceholderText("CipherChaos will sass you here...")
            ...
            self.add_quip("Entropy buffet's open—who's hungry for bits?")
            return panel
    ...
    def create_log_panel(self):
        ...
        # Add initial log
        self.add_log("CipherChaos Chaos System v2.1 initialized with PQC support")
        if PQC_AVAILABLE:
    ...
    def on_pqc_checkbox_changed(self, state):
        ...
        if self.worker:
            ...
            if self.worker.pqc_enabled:
                ...
                self.add_quip("Kyber crystals aligned—let the lattice sing.")
            else:
    ...
    def on_esp_status_updated(self, status):
        ...
        try:
            ...
            if usb_bytes > 0 and usb_bytes % 50 == 0:
                self.add_quip("USB jitter swallowed whole—entropy's dessert course! (•̀ᴗ•́ )و")
...
def main():
    ...
    app.setApplicationName("CipherChaos Chaos System")
